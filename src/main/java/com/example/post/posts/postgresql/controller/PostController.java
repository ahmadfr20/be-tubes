package com.example.post.posts.postgresql.controller;
...
import com.example.post.posts.postgresql.repository.PostRepository;
...
public class PostController {
	...
	public ResponseEntity<Post> createPost(@RequestBody Post post) {
		try {
			Post _post = postRepository
					.save(new Post(post.getTitle(), post.getDescription(), post.getPenulis(), false));
	...
	public ResponseEntity<Post> updatePost(@PathVariable("id") long id, @RequestBody Post post) {
		...
		if (postData.isPresent()) {
            ...
            _post.setPenulis(post.getPenulis());
